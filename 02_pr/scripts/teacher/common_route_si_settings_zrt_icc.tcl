# ============================================================================
# 路由 SI 设置 (Route SI/Signal Integrity Settings)
# 功能: 配置串扰处理、最大转换时间修复、Xtalk 延迟、信号完整性约束
# ============================================================================
...
#set ICC_NUM_CORES 1
# ========== 多线程与核心配置 ==========
set ICC_NUM_CORES [if { [ file exists /proc/cpuinfo ] } { sh grep MHz /proc/cpuinfo | wc -l } ]
#set_host_options -max_cores $ICC_NUM_CORES
set_host_options -max_cores [expr $ICC_NUM_CORES/2]
...
# ========== 冗余过孔配置 ==========
set ICC_DBL_VIA FALSE
set ICC_DBL_VIA_FLOW_EFFORT "LOW"
if {$ICC_DBL_VIA } {
#dxzhang:should update VIAXX's name
...
# ========== 天线规则处理 ==========
set ICC_FIX_ANTENNA 1
set ANTENNA_RULES_FILE "antenna_rules.tcl"
