# ============================================================================
# 天线规则定义 (Antenna Rules Definition)
# 功能: 定义每层金属的天线比例限制、二极管保护策略、抗静电规则
# ============================================================================
...
# ========== 金属层天线规则定义 (M1-M6) ==========
define_antenna_layer_rule $lib -mode 4 -layer "M1" -ratio 400 -diode_ratio {0.203 0 400 2200}
define_antenna_layer_rule $lib -mode 4 -layer "M2" -ratio 400 -diode_ratio {0.203 0 400 2200}
define_antenna_layer_rule $lib -mode 4 -layer "M3" -ratio 400 -diode_ratio {0.203 0 400 2200}
define_antenna_layer_rule $lib -mode 4 -layer "M4" -ratio 400 -diode_ratio {0.203 0 400 2200}
define_antenna_layer_rule $lib -mode 4 -layer "M5" -ratio 400 -diode_ratio {0.203 0 400 2200}
define_antenna_layer_rule $lib -mode 4 -layer "M6" -ratio 400 -diode_ratio {0.203 0 8000 30000}

# ========== 过孔层天线规则定义 (V1-V5) ==========
define_antenna_layer_rule $lib -mode 4 -layer "V1" -ratio 20 -diode_ratio {0.203 0 83.33 75}
...
define_antenna_layer_rule $lib -mode 4 -layer "V4" -ratio 20 -diode_ratio {0.203 0 83.33 75}
define_antenna_layer_rule $lib -mode 4 -layer "V5" -ratio 20 -diode_ratio {0.203 0 83.33 75}
