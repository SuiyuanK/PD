...
### open database
file delete -force ${nlib_dir}/${design}_08_route_opt.nlib
copy_lib -from_lib ${nlib_dir}/${design}_07_route.nlib -to_lib ${nlib_dir}/${design}_08_route_opt.nlib
current_lib ${design}_08_route_opt.nlib
open_block ${design}
...
#### rc_scaling : set_extraction_option
...
# 多轮 不超过3
route_opt
# 修改option针对 不同方面 进行 power opt /crosstalk(xtalk) opt /hold + stepup /ccd enaable
